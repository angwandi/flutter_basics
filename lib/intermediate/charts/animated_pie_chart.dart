...
class AnimatedPieView extends StatefulWidget {
  static const id ='pie';
  @override
...
class _State extends State<AnimatedPieView> {
      ...
      body:  Container(
          ...
          child:  Center(
            child:  Column(
              children: <Widget>[
                 Text('Sales Data'),
                // Expanded(child:  charts.PieChart<Sales,int>( //old version
                 Expanded(child:  charts.PieChart<dynamic>( // version
                    _chartdata,
                    animate: true,
